...
$(document).ready(function() {
    $('#verification-btn').click(function() {
        ...
        $('#verified-status').text('Processing...');
        ...
        if(code == savedCode){ 
            ...
            var getUserDetailsEndPoint = 'http://192.46.214.108:9090/api/auth/getUser/' + payload.sub;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var updateVerificationStatus = 'http://192.46.214.108:9090/api/auth/verify/update/' + id;
