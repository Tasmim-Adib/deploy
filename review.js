$(document).ready(function(){
    ...
    if (isAuthenticated == null) {
        ...
        var unReviewedQuestionEndPoint = 'http://192.46.214.108:9090/api/auth/contribution/unreview/' + email;
                ...
                if(contributions === null){
                    ...
                    $.each(contributions, function (index, item) {
                        ...
                        $ratingButton.click(function(){
                            ...
                            var reviewSaveEndPoint = 'http://192.46.214.108:9090/api/auth/review/add';
