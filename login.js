...
$(document).ready(function(){
  $('#account-sign-up').click(function(event){
		...
		var registerEndPoint = 'http://192.46.214.108:9090/api/auth/register';
		var sendMailEndPoint = 'http://192.46.214.108:9090/api/auth/sendmail';
  	...
  	$('#account-sign-in').click(function(event){
		...
		var authenticateEndPoint = 'http://192.46.214.108:9090/api/auth/authenticate';
